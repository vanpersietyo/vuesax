...
<head>
	...
	<title>DASHBOARD E-PAYMENT SURABAYA</title>
	...
	<!-- BEGIN: Page CSS-->
	<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/vuesax/');?>app-assets/css/core/menu/menu-types/vertical-menu.css">
...
<!-- END: Head-->
<body class="vertical-layout vertical-menu-modern 2-columns  navbar-floating footer-static <?php if($dark_mode){echo "dark-layout";}?>" data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
